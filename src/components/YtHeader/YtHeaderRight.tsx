export default function YtHeaderRight() {
  return (
    <article className="w-[225px] flex justify-end">
      <ul className="flex items-center gap-[8px]">
        <li>
          <a href="#" className="p-2 block rounded-full hover:bg-[#e3e3e3]">
        ...
        <li>
          <article className="px-[14px] box-content ">
            <button className="w-8 h-8 block rounded-full bg-black focus:border border-blue-300"></button>
          </article>
        </li>
      </ul>
    </article>
